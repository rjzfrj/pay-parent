 ...
 */
@Repository
public class ZyppOperatorRoleDaoImpl extends PermissionBaseDaoImpl<ZyppOperatorRole> implements ZyppOperatorRoleDao {
	 ...
	 * @return list .
	 */
	public List<ZyppOperatorRole> listByOperatorId(Long operatorId) {
	 ...
	 * @return
	 */
	public List<ZyppOperatorRole> listByRoleId(Long roleId) {
