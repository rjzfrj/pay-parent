...
public interface ZyppRolePermissionService {
	 ...
	 * 创建pmsRolePermission
	 */
	void saveData(ZyppRolePermission pmsRolePermission);

	/**
	 * 修改pmsRolePermission
	 */
	void updateData(ZyppRolePermission pmsRolePermission);
	 ...
	 * @return
	 */
	PageBean listPage(PageParam pageParam, ZyppRolePermission pmsRolePermission);
