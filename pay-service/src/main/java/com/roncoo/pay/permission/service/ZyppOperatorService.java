...
public interface ZyppOperatorService {
	 ...
	 * 创建pmsOperator
	 */
	void saveData(ZyppOperator pmsOperator);

	/**
	 * 修改pmsOperator
	 */
	void updateData(ZyppOperator pmsOperator);
	 ...
	 * @return
	 */
	PageBean listPage(PageParam pageParam, ZyppOperator pmsOperator);
	 ...
	 *            .
	 */
	public void saveOperator(ZyppOperator pmsOperator, String roleOperatorStr);
	 ...
	 *            .
	 */
	void updateOperator(ZyppOperator pmsOperator, String roleOperatorStr);
